...
rm(SP500.temp, CAC40.temp, SP500.price, CAC40.price, NK225.temp, NK225.price)

# Plotting =====================================================================

# Price trend plot
# plot(SP500, type = "l", ylim = range(SP500, CAC40), col = "blue",
...
NK225.params.t <- fitdistr(NK225, "t")$estimate
...
x <- seq(-0.4, 0.4, 0.001)
lines(x, dstd(x, NK225.params.t[1], NK225.params.t[2]*1.2, NK225.params.t[3]), type = "l")
...
NK225.u.t <- pstd(NK225, NK225.params.t[1], NK225.params.t[2]*1.2, NK225.params.t[3])
...
LcKS(NK225.u.t, cdf = "punif")$p.value
ad.test(SP500.u.t, null = "punif")$p.value
ad.test(CAC40.u.t, null = "punif")$p.value
ad.test(NK225.u.t, null = "punif")$p.value



plot(SP500.u.t, CAC40.u.t)
plot(SP500.u.t, NK225.u.t) # Preferrable combination, grumble copula maybe
plot(NK225.u.t, CAC40.u.t)
